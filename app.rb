...
class App
  ...
  def create_person(name, age, type, parent_permission, specialization: nil)
    if type == 'teacher'
      teacher = Teacher.new(name, age, specialization)
      @people << teacher
      puts "Person with ID #{teacher.id} was created."
    elsif type == 'student'
      student = Student.new(name, age, parent_permission)
      @people << student
      puts "Person with ID #{student.id} was created."
    end
  end
...
def create_person(app)
  ...
  if type == 'teacher'
    ...
    print 'Get parent parent permission? [y/n]: '
